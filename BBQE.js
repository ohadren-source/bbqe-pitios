  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.content}>
        ...
        {threatResult && (
          <View style={[styles.resultBox, threatResult.isBreach ? styles.resultDanger : styles.resultSafe]}>
            ...
            {threatResult.isBreach && (
              <>
                <Text style={styles.resultText}>
                  Found in {threatResult.breachCount} breach{threatResult.breachCount !== 1 ? 'es' : ''}:
                </Text>
                {threatResult.sources && threatResult.sources.map((source, idx) => (
